      ...
      foreach ($_GET as $key=>$value) {
          if (is_array($value)) {
              foreach ($value as $key2 => $val2) {
                  if ($key2 == 'keyword') {
                      ...
                      if (isset($_REQUEST[$key][$key2])) {
                          $_REQUEST[$key][$key2] = preg_replace('/'.$unStrictReplace.'/', '', $val2);
                      }
                  } else {
                      $_GET[$key][$key2] = preg_replace('/'.$strictReplace.'/', '', $val2);
                      if (isset($_REQUEST[$key][$key2])) {
                          $_REQUEST[$key][$key2] = preg_replace('/'.$strictReplace.'/', '', $val2);
                      }
                  }
                  unset($GLOBALS[$key]);
              }
              ...
              if ($key == 'keyword') {
                  ...
                  if (isset($_REQUEST[$key])) {
                      $_REQUEST[$key] = preg_replace('/'.$unStrictReplace.'/', '', $value);
                  }
              } else {
                  $_GET[$key] = preg_replace('/'.$strictReplace.'/', '', $value);
                  if (isset($_REQUEST[$key])) {
                      $_REQUEST[$key] = preg_replace('/'.$strictReplace.'/', '', $value);
                  }
              }
              unset($GLOBALS[$key]);
          }
