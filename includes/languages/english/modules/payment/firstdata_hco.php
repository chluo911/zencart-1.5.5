 ...
 */
  ...
  if (IS_ADMIN_FLAG === true) {
      if (MODULE_PAYMENT_FIRSTDATA_PAYMENTPAGES_STATUS == 'True') {
          define(
              'MODULE_PAYMENT_FIRSTDATA_PAYMENTPAGES_TEXT_DESCRIPTION',
              '<a target="_blank" href="https://' . (MODULE_PAYMENT_FIRSTDATA_PAYMENTPAGES_TESTMODE == 'Sandbox' ? 'demo.' : '') . 'globalgatewaye4.firstdata.com">First Data GGe4 Merchant Login</a>' .
        ...
        'Then obtain the Payment Page ID, Transaction Key and Response Key from First Data and enter them here. They can be found by logging into your First Data account, choosing Payment Pages, and clicking on the desired Page ID and navigating to the Security section.'
          ...
          define('MODULE_PAYMENT_FIRSTDATA_PAYMENTPAGES_TEXT_DESCRIPTION', 'Hosted Checkout Payment Pages are available to all First Data, Global Gateway e4, and Linkpont merchants.<br><br>
             ...
             <a target="_blank" href="https://www.zen-cart.com/partners/firstdatahosted/">Click Here to Sign Up for a First Data Hosted Checkout Account</a><br><br>
             <a target="_blank" href="https://globalgatewaye4.firstdata.com/">Click to Login to the First Data GGe4 Merchant Area</a>');
      }
  }
