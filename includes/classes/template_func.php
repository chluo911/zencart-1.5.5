...
{
    public function __construct($template_dir = 'default')
    {
        $this->info = array();
    }

    public function get_template_part($page_directory, $template_part, $file_extension = '.php')
    {
    ...
    public function get_template_dir($template_code, $current_template, $current_page, $template_dir, $debug=false)
    {
    ...
    public function file_exists($file_dir, $file_pattern, $debug=false)
    {
        $file_found = false;
