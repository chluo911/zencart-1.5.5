...
class base
{
    ...
    public function & getStaticProperty($var)
    {
        static $staticProperty;
        return $staticProperty;
    }
    public function & getStaticObserver()
    {
        return base::getStaticProperty('observer');
    }
    public function setStaticObserver($element, $value)
    {
    ...
    public function unsetStaticObserver($element)
    {
        $observer =  & base::getStaticObserver();
