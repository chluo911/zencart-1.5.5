...
{
    public function sql_cache_exists($zf_query, $zf_cachetime)
    {
        global $db;
    ...
    public function sql_cache_is_expired($zf_query, $zf_cachetime)
    {
        global $db;
        $zp_cache_name = $this->cache_generate_cache_name($zf_query);
        switch (SQL_CACHE_METHOD) {
    ...
    public function sql_cache_expire_now($zf_query)
    {
        global $db;
        $zp_cache_name = $this->cache_generate_cache_name($zf_query);
        switch (SQL_CACHE_METHOD) {
    ...
    public function sql_cache_store($zf_query, $zf_result_array)
    {
        global $db;
        $zp_cache_name = $this->cache_generate_cache_name($zf_query);
        switch (SQL_CACHE_METHOD) {
    ...
    public function sql_cache_read($zf_query)
    {
        global $db;
        $zp_cache_name = $this->cache_generate_cache_name($zf_query);
        switch (SQL_CACHE_METHOD) {
    ...
    public function sql_cache_flush_cache()
    {
        global $db;
        switch (SQL_CACHE_METHOD) {
      case 'file':
    ...
    public function cache_generate_cache_name($zf_query)
    {
        switch (SQL_CACHE_METHOD) {
      case 'file':
