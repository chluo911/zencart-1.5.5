...
class authorizenet_echeck extends base
{
    ...
    public function __construct()
    {
        ...
        if (IS_ADMIN_FLAG === true) {
            ...
            if ($this->enabled) {
                ...
                if (strlen(MODULE_PAYMENT_AUTHORIZENET_ECHECK_MD5HASH) > 20) {
    ...
    /**
      ...
      * @return string
      */
    public function RENAME_admin_notification($zf_order_id)
    {
        global $db;
        $output = '';
    ...
    // Populate an array that contains all of the data to be sent to Authorize.net
        ...
        if (defined('AUTHORIZENET_DEVELOPER_MODE')) {
            ...
            if (AUTHORIZENET_DEVELOPER_MODE == 'echo' || MODULE_PAYMENT_AUTHORIZENET_ECHECK_DEBUGGING == 'echo') {
                $url = $dumpurl;
            }
        ...
        if (MODULE_PAYMENT_AUTHORIZENET_ECHECK_DEBUGGING == 'echo') {
            $url = $dumpurl;
        }
