 ...
 * @version $Id: Author: zcwilt  Sun Jan 3 21:07:09 2016 +0000 New in v1.5.5 $
 */
...
class AbstractSagepayAPI extends base
{
     ...
     * @return mixed
     */
    public function getSagepayCurrency()
    {
     ...
     * @return string
     */
    public function getResponseErrorMessage($status)
    {
    ...
    protected function errorLog($errorMessages = array())
    {
        ...
        zen_mail(
            ...
            'Sagepay Form Alert ' . date('M-d-Y h:i:s'),
            $message,
            STORE_OWNER,
            STORE_OWNER_EMAIL_ADDRESS,
            array('EMAIL_MESSAGE_HTML' => nl2br($message)),
            'debug'
        );
    }
    ...
    protected function buildStandardTransactionDetails()
    {
        ...
        $entries['Amount'] = number_format(
            $order->info['total'] * $currencies->get_value($sagepayCurrency),
