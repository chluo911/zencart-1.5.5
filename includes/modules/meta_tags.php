...
if ($metatag_page_name != 'index') {
    if (defined('META_TAG_TITLE_' . strtoupper($metatag_page_name))) {
        define('META_TAG_TITLE', constant('META_TAG_TITLE_' . strtoupper($metatag_page_name)));
    }
    if (defined('META_TAG_DESCRIPTION_' . strtoupper($metatag_page_name))) {
        define('META_TAG_DESCRIPTION', constant('META_TAG_DESCRIPTION_' . strtoupper($metatag_page_name)));
    }
    if (defined('META_TAG_KEYWORDS_' . strtoupper($metatag_page_name))) {
        define('META_TAG_KEYWORDS', constant('META_TAG_KEYWORDS_' . strtoupper($metatag_page_name)));
    }
}
...
// EZ-Pages:
  ...
  if (defined('META_TAG_DESCRIPTION_EZPAGE_'.$ezpage_id)) {
      define('META_TAG_DESCRIPTION', constant('META_TAG_DESCRIPTION_EZPAGE_'.$ezpage_id));
  }
  if (defined('META_TAG_KEYWORDS_EZPAGE_'.$ezpage_id)) {
      define('META_TAG_KEYWORDS', constant('META_TAG_KEYWORDS_EZPAGE_'.$ezpage_id));
  }
