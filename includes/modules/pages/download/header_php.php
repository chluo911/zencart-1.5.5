...
if (!file_exists(DIR_FS_DOWNLOAD . $downloads->fields['orders_products_filename'])) {
    die('Sorry. File not found. Please contact the webmaster to report this error.<br />c/f: ' . $downloads->fields['orders_products_filename']);
}
...
function zen_unlink_temp_dir($dir)
{
    ...
    while ($subdir = readdir($h1)) {
        ...
        if ($exptime + SYMLINK_GARBAGE_COLLECTION_THRESHOLD > time()) {
            continue;
        }
