...
// Virtual Products
    if (!isset($pInfo->products_virtual)) {
        $pInfo->products_virtual = DEFAULT_DOCUMENT_PRODUCT_PRODUCTS_VIRTUAL;
    }
...
// Always Free Shipping
    if (!isset($pInfo->product_is_always_free_shipping)) {
        $pInfo->product_is_always_free_shipping = DEFAULT_DOCUMENT_PRODUCT_PRODUCTS_IS_ALWAYS_FREE_SHIPPING;
    }
