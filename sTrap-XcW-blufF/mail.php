...
<?php if (EMAIL_USE_HTML != 'true') {
          echo TEXT_WARNING_HTML_DISABLED.'<br />';
      } ?>
<?php $html_preview = zen_output_string_protected($_POST['message_html']);
      echo(stristr($html_preview, '<br') ? $html_preview : nl2br($html_preview)); ?><hr /></td>
            </tr>
            <tr>
