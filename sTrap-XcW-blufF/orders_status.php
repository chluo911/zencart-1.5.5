  ...
  while (!$orders_status->EOF) {
      ...
      if (DEFAULT_ORDERS_STATUS_ID == $orders_status->fields['orders_status_id']) {
          ...
          echo '                <td class="dataTableContent">' . $orders_status->fields['orders_status_name'] . '</td>' . "\n";
                ...
                <td class="dataTableContent" align="right"><?php if (isset($oInfo) && is_object($oInfo) && ($orders_status->fields['orders_status_id'] == $oInfo->orders_status_id)) {
          echo zen_image(DIR_WS_IMAGES . 'icon_arrow_right.gif', '');
      } else {
          echo '<a href="' . zen_href_link(FILENAME_ORDERS_STATUS, 'page=' . $_GET['page'] . '&oID=' . $orders_status->fields['orders_status_id']) . '">' . zen_image(DIR_WS_IMAGES . 'icon_info.gif', IMAGE_ICON_INFO) . '</a>';
      } ?>&nbsp;</td>
              </tr>
<?php
...
<?php
  ...
  switch ($action) {
    ...
    case 'delete':
      ...
      if ($remove_status) {
          $contents[] = array('align' => 'center', 'text' => '<br>' . zen_image_submit('button_delete.gif', IMAGE_DELETE) . ' <a href="' . zen_href_link(FILENAME_ORDERS_STATUS, 'page=' . $_GET['page'] . '&oID=' . $oInfo->orders_status_id) . '">' . zen_image_button('button_cancel.gif', IMAGE_CANCEL) . '</a>');
      }
      break;
    default:
