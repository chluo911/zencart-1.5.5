...
// the following is for display later
  ...
  $hist_details = $db->Execute($hist_query);
      ...
      if (zen_not_null($hist_details->fields['project_version_patch'])) {
          $sinfo .= '&nbsp;&nbsp;Patch: ' . $hist_details->fields['project_version_patch'];
      }
      if (zen_not_null($hist_details->fields['project_version_date_applied'])) {
          $sinfo .= ' &nbsp;&nbsp;[' . $hist_details->fields['project_version_date_applied'] . '] ';
      }
      if (zen_not_null($hist_details->fields['project_version_comment'])) {
          $sinfo .= ' &nbsp;&nbsp;(' . $hist_details->fields['project_version_comment'] . ')';
      }
      $sinfo .=  '<br />';
