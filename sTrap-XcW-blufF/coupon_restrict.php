 ...
 */
  ...
  if (isset($_POST['cPath'])) {
      $_POST['cPath'] = (int)$_POST['cPath'];
  }
  if (isset($_POST['cPath_prod'])) {
      $_POST['cPath_prod'] = (int)$_POST['cPath_prod'];
  }
  if (isset($_GET['build_cat'])) {
      $_GET['build_cat'] = (int)$_GET['build_cat'];
  }
  ...
  if (isset($_GET['action']) && $_GET['action']=='switch_status') {
      if (isset($_POST['switchStatusProto'])) {
          ...
          $new_status = 'N';
          if ($status->fields['coupon_restrict'] == 'N') {
              $new_status = 'Y';
          }
